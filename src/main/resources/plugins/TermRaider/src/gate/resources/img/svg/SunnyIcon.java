...
public class SunnyIcon implements
		javax.swing.Icon {
	/**
...
float alpha__0_0_0_1_0_1 = origAlpha;
origAlpha = origAlpha * 1.0f;
g.setComposite(AlphaComposite.getInstance(3, origAlpha));
Shape clip__0_0_0_1_0_1 = g.getClip();
...
g.setPaint(paint);
g.fill(shape);
origAlpha = alpha__0_0_0_1_0_1;
g.setTransform(defaultTransform__0_0_0_1_0_1);
g.setClip(clip__0_0_0_1_0_1);
float alpha__0_0_0_1_0_2 = origAlpha;
origAlpha = origAlpha * 1.0f;
g.setComposite(AlphaComposite.getInstance(3, origAlpha));
Shape clip__0_0_0_1_0_2 = g.getClip();
...
g.setStroke(stroke);
g.draw(shape);
origAlpha = alpha__0_0_0_1_0_2;
g.setTransform(defaultTransform__0_0_0_1_0_2);
g.setClip(clip__0_0_0_1_0_2);
...
g.setClip(clip_);
	 ...
	 */
	public SunnyIcon(Dimension size) {
	this.width = size.width;
	this.height = size.width;
	}

	public SunnyIcon(int width, int height) {
	this.width = width;
	this.height = height;
	}
